...
<html lang="ko">
  ...
  <body>
    <div class="container">
      <h1 class="mb-3">onclick 이벤트 연습</h1>

      <div class="row mb-3">
        <div class="col">
          <!--
            이 버튼에서 : 이벤트 소스
            onclick 이벤트가 발생하면 : 이벤트 종류
            등록()함수가 실행되게한다 : 이벤트 핸들러 함수 지정
          -->
    ...
    <div class="row mb-3">
      <div class="col">
        ...
        <div class="row mb-3">
          <div class="col">
            <h3>onkeydown, onkeypress, onkeyup</h3>
            <input
              type="text"
              name="username"
              onkeydown="down()"
        ...
        <div class="row mb-3">
          <div class="col">
            ...
            <div class="row mb-3">
              <div class="col">
                <h3>onsubmit 이벤트</h3>
                <form class="border p-3 bg-light" onsubmit="폼입력값체크하기()" method="post" action="login.jsp">
                  <div class="mb-3">
