  ...
  <body>
    <div class="container">
      ...
      <div class="row mb-3">
        <div class="col">
          ...
          <!--
              이벤트가 발생한 엘리먼트를 이벤트핸들러 함수의 매개변수로 전달할 수 있다.
              this는 이벤트가 발생한 그 엘리먼트를 나타낸다.
          -->
          <button class="btn btn-primary" onclick="btn2(this)">버튼2</button>
          <button class="btn btn-primary" onclick="btn3(event, this)">
            버튼3
          </button>
        </div>
    ...
    <script type="text/javascript">
      ...
      function btn2(el) {
        ...
        console.log("엘리먼트", el.textContent);
      }
      function btn3(e, el) {
        console.log("이벤트객체", e);
        console.log("엘리먼트객체", el);
