...
<div class="container">   
	...
	<div class="row">
		<div class="col">
			<p class="p-3 border-top border-bottom">This section contains a complete JavaScript reference documentation</p>
		</div>
	</div>
	<!-- 이 섹션의 컨텐츠를 표시할 행을 정의한다. -->
	<div class="row">
		<div class="col">
			<h2>JavaSciprt Reference</h2>
			<p>The reference describe the properties and methods of all JavaScript objects, along with examples.</p>
			<div class="row">
