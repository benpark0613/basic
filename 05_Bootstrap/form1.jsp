			...
			<form class="border p-3 bg-light" method="post" action="register.jsp">
				...
				<div class="mb-3">
					<div class="form-check form-check-inline">
						<input class="form-radio-input" type="radio" name="jobType" id="job-type-1" value="R" checked="checked"/>
						<label class="form-check-label" for="job-type-1">정규직</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-radio-input" type="radio" name="jobType" id="job-type-2" value="T"/>
