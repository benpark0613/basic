 ...
 * 	구현부가 없는 메소드를 가질 수 있기 때문에 new 키워드로 객체생성할 수 없다.
 */
public abstract class AbstractPhone implements Phone {
	 ...
	 *   멤버변수를 가질 수 있기 때문에, 그 멤버변수를 초기화하기 위한 생성자 메소드를 포함할 수 있다.
	 * - 추상클래스의 생성자 메소드는 이 클래스를 상속받은 구현클래스가 객체 생성될 때 구현클래스의 생성자 메소드에서
	 *   super()메소드로 실행된다.
	 */
