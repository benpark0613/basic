...
public class DateFormatSample1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("### Data객체의 toString() 메소드가 반환하는 문자열 출력하기");
		System.out.println(date);
		System.out.println(date.toString());
		 
		// Date를 지정된 패턴의 문자열로 바꾸기
		System.out.println("Date에 포함된 날짜를 형식화된 텍스트로 변환하기");
		SimpleDateFormat sdf1 = new SimpleDateFormat();
		
		// Date에 포함된 날짜와 시간정보를 "1900-01-01" 형식으로 포맷팅하는 패턴을 적용하기
